...
\begin{posterbox}[name=figures,column=1,below=Conclusion, above=bottom]{Science Data Literacy Development}
% 데이터 리터러시 함양
...
\href{https://github.com/Kiehyun/ISCCE2026/blob/main/appendix/The_Keeling_Curve_in_Action.ipynb}{%
  \parbox{\linewidth}{%
